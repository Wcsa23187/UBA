...
class Attacker(object):
    def __init__(self):
        ...
        # 2577
        # self.target_id_list = [2577]
        #self.target_id_list = [3530]
        item = int(sys.argv[sys.argv.index('--oneitem') + 1])
        # self.target_id_list = [68]
        self.target_id_list = [item]
        
        # self.target_id_list = [1104]
        # self.target_id_list = [1551, 2510, 1167, 2362, 2233, 2801, 905, 1976, 3239, 3262]
        self.attack_num = self.args.attack_num
        self.filler_num = self.args.filler_num
        # self.injected_path = self.args.injected_path
        '''
        self.allseed = self.args.allseed
    ...
    def generate_injectedFile(self, fake_array=None):
        ...
        data = pd.read_csv(injected_path)
        data.to_csv('/output/inject_data.csv')
...
class WGANAttacker(Attacker):
    ...
    def opt_adv_intent(self, fake_profiles):
        ...
        fake_array[:, self.target_id_list] = 5.0
        '''
